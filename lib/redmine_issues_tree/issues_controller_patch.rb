...
unless IssuesController.included_modules.include?(RedmineIssuesTree::IssuesControllerPatch)
  IssuesController.send(:prepend, RedmineIssuesTree::IssuesControllerPatch)
end
